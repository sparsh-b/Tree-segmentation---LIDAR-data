...
2) At each step of expansion:
   ...
   2)  If the variation of points' z-coordinates is sufficient, but there is crowding in the bottom, it means that the cluster is a part of the base of a vertical object(eg: tree, building). These crowded points are removed from the cluster so that, in the next step, the culster will expand in the direction of the vertical object.![cluster_expansion](https://user-images.githubusercontent.com/45140884/122601840-89755180-d08f-11eb-978a-9bfac2e28501.jpg)
     In the above picture, it can be seen that without 2-(ii) part of the algo, cluster expanded in the direction of pavement. But with 2-(ii), it expanded in the direction of the tree.
3) Finally, those clusters which correspond to the general size of a tree(for the below reported performance, size = 50 to 2400 points) are selected.
4) Clusters generated by the algo for the map 2_ac in the dataset: ![clusters_vs_GT](https://user-images.githubusercontent.com/45140884/122628108-d417bd80-d0d1-11eb-96dc-454e377608e6.jpg)
